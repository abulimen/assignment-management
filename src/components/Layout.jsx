...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-canvas">
      ...
      <header className="bg-surface/90 backdrop-blur border-b border-line sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/dashboard" className="flex items-center gap-2.5 min-h-11 py-2" aria-label="Draftly — dashboard">
              <BrandMark className="h-7 w-7" />
              <span className="text-lg font-semibold tracking-tight text-gray-900">Draftly</span>
            </Link>
