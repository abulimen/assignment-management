...
// telemetry. Copy leads with the problem ("Stop grading blind."); the
// recorded document is the hero artifact.
      ...
      <div className="rounded-md bg-sheet p-6 sm:p-7">
        ...
        <div className="mt-4 rounded border border-cobalt-600/30 bg-cobalt-600/10 p-3">
          ...
          <p className="mt-2.5 font-mono text-[9px] tracking-[0.14em] text-cobalt-600">
            PASTE +412 CHARS · SARAH · 21:14:07
          </p>
        </div>
        <div className="mt-4 space-y-2" aria-hidden="true">
...
const RECORD_EVENTS = [
  { time: '20:06:41', label: 'Workspace opened', detail: 'Group 7 · 4 members', live: false },
  { time: '20:09:12', label: 'First keystroke', detail: 'Jonathan', live: false },
  { time: '21:14:07', label: 'Paste detected', detail: '+412 chars · Sarah', live: true },
  { time: '21:19:04', label: 'Contribution status changed', detail: 'David marked Done', live: false },
  { time: '21:32:55', label: 'Section reordered', detail: 'Methods moved above Results', live: false },
  { time: '21:47:32', label: 'Sealed at submission', detail: 'Snapshot locked · Jonathan submitted', live: true },
];
...
const EVIDENCE_ROWS = [
  ...
  {
    title: 'For students',
    body: 'Every contributor can see exactly what is recorded about their own work and how it is used. Nothing is collected quietly, and nothing is for show.',
  },
  {
        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-6">
          ...
          <nav aria-label="Primary" className="hidden lg:block">
            <ul className="flex items-center gap-1">
              ...
              <li>
                <a href="#evidence" className={`${ghostLink} font-mono text-[11px] uppercase tracking-[0.18em]`}>
                  Evidence
                </a>
              </li>
            </ul>
      ...
      <main id="main">
            ...
            <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
              <div>
                ...
                <p className="mt-5 max-w-md text-lg leading-8 text-graphite-300">
                  Draftly writes the assignment&rsquo;s log as the work unfolds. Nothing is added
                  after the fact, and nothing is edited away.
                </p>
              </div>
        ...
        <section id="modes" className="scroll-mt-20 border-t border-graphite-800">
          <div className="mx-auto max-w-6xl px-6 py-24 sm:py-32">
            ...
            <div className="mt-14 grid gap-px overflow-hidden rounded-xl border border-graphite-800 bg-graphite-800 lg:grid-cols-5">
              <article className="bg-graphite-900 p-8 sm:p-10 lg:col-span-3">
                <p className="font-mono text-[11px] tracking-[0.24em] text-cobalt-300">MODE 01</p>
                <h3 className="mt-4 font-instrument text-2xl font-bold tracking-tight text-sheet">
                  Individual assignments
                </h3>
                <p className="mt-4 max-w-lg text-base leading-7 text-graphite-300">
                  Each student writes in their own document. The record tracks when work began,
                  how it developed, and what was pasted in, so an individual grade rests on the
                  work itself rather than on impressions.
                </p>
                <p className="mt-6 font-mono text-[10px] uppercase tracking-[0.18em] text-graphite-500">
                  One writer &middot; Full event log &middot; Sealed draft
                </p>
              </article>
              <article className="bg-graphite-900 p-8 sm:p-10 lg:col-span-2">
                <p className="font-mono text-[11px] tracking-[0.24em] text-cobalt-300">MODE 02</p>
                <h3 className="mt-4 font-instrument text-2xl font-bold tracking-tight text-sheet">
                  Group assignments
                </h3>
                <p className="mt-4 text-base leading-7 text-graphite-300">
                  The group shares one sectioned document in realtime. Members organize the
                  sections, mark their contribution Done, and the leader submits. The record
                  separates who contributed what.
                </p>
                <p className="mt-6 font-mono text-[10px] uppercase tracking-[0.18em] text-graphite-500">
        ...
        {/* ---------------------------------------------------- evidence */}
        <section id="evidence" className="scroll-mt-20 border-t border-graphite-800 bg-graphite-950">
          <div className="mx-auto max-w-6xl px-6 py-24 sm:py-32">
            <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
              <div>
            ...
            <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
              <div>
                ...
                <p className="mt-5 max-w-xl text-lg leading-8 text-sheet/80">
                  We are onboarding a first cohort for the private beta. Bring one assignment,
                  let your students work it inside Draftly, and grade it with the record beside
                  it.
                </p>
              </div>
