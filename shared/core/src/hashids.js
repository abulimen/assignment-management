...
// Create a pseudo-random permutation of the alphabet using a salt string
...
// Feistel-like reversible integer scrambling to eliminate sequential patterns
...
export function decodeId(str) {
  ...
  // Backwards compatibility fallback: direct numeric ID (e.g. "12")
  if (/^\d+$/.test(trimmed)) {
